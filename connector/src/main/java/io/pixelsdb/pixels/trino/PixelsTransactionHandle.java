...
public class PixelsTransactionHandle implements ConnectorTransactionHandle
{
    ...
    private boolean writeProhibited;
    ...
    @JsonProperty public boolean isWriteProhibited() { return writeProhibited; }
    @JsonProperty public void setWriteProhibited(boolean value) { writeProhibited = value; }
